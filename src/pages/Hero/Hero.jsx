...
const Hero = () => {
    return (
        ...
        <div>
            ...
            <div className='md:flex md:justify-center gap-2 mt-4 mx-auto'>
                <input className='border md:w-2/5 p-2 rounded-md focus:outline-none' type="text" name="" placeholder='Search phone by Name' />
                <div>
